...
const Sidebar = ({ onCreateClick ,isCreateModalOpen}) => {
  ...
  return (
    <>
      <div className={`${search || notification ? 'w-[72px]' : 'w-[72px] lg:w-[245px]'} h-screen fixed ${isCreateModalOpen ? '' : 'z-[99]'} bg-white transition-all duration-200 border-r border-gray-200`}>
        <div className="w-full h-full p-2.5">
          ...
          <ul className="flex flex-col space-y-2">
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block">Home</span>}
            </li>
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block">Search</span>}
            </li>
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block">Explore</span>}
            </li>
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block">Reels</span>}
            </li>
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block">Messages</span>}
            </li>
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block">Notifications</span>}
            </li>
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block" onClick={onCreateClick}>Create</span>}
            </li>
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block">Profile</span>}
            </li>
            ...
            >
              ...
              {!search&&!notification && <span className="ml-4 text-base hidden lg:block">More</span>}
            </li>
          </ul>
        </div>
      </div>
